...
List<RecipeData> recipeDataList = [
  RecipeData(
      ...
      description:
          'A classic French dessert, this tart combines a buttery biscuit base with a sweet almond frangipane filling, layered with apple slices and topped with flaked almonds. Best served warm, often accompanied by cream or ice cream.',
  ...
  RecipeData(
      ...
      description:
          'A traditional British pudding, this dish pairs a tart apple and blackberry compote with a golden, buttery crumble topping. It’s typically enjoyed warm with a scoop of vanilla ice cream.',
      difficulty: 'Easy'),
  RecipeData(
    ...
    description:
        'A classic English dessert made by layering buttered bread slices with dried fruits, often spiced with cinnamon and nutmeg, and covered in a creamy custard before baking.',
    difficulty: 'Easy',
  ),
  RecipeData(
    ...
    description:
        'A luxurious dish where a beef fillet is coated in mushroom duxelles, wrapped in Parma ham and puff pastry, then baked to a golden crust. The beef is usually served medium-rare and sliced to reveal layers.',
    difficulty: 'Advanced',
  ),
  RecipeData(
    ...
    description:
        'A layered casserole made by stacking tortillas with shredded chicken, enchilada sauce, and cheese. This hearty dish is baked until bubbly and slightly browned, often served with toppings like sour cream or guacamole.',
    difficulty: 'Easy',
  ),
  RecipeData(
    ...
    description:
        'A rich and indulgent chocolate cake, often layered with chocolate filling or ganache. This dessert is dense and moist, ideal for chocolate lovers and frequently served with whipped cream or fruit.',
    difficulty: 'Intermediate',
  ),
  RecipeData(
    ...
    description:
        'A fresh, protein-packed salad featuring quinoa, grilled chicken, and Greek-inspired ingredients like feta, olives, and mint. It’s dressed with olive oil and lemon, perfect as a light meal.',
    difficulty: 'Easy',
  )
];
